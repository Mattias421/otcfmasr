...
orion hunt -n prelim_loss_hpoptv3 -c hparams/orion.yaml python train.py hparams/train.yaml --precision=fp16 --eval_precision=fp16 --data_folder=$DATA --hpopt hparams/hpopt.yaml --hpopt_mode orion \
